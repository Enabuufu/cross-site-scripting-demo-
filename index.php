...
<html>
  ...
  <div id="sidebar" class="nav-collapse ">
    <header  style = " background: #4ECDC4;">
      <a style ="color: #fff;" href="index.php" class="logo">XSS Me</a>
      <a href="index.php" class="button"  style ="background: #fff; color : black;">Home</a>
      <a href="index.php?page=About" class="button" style ="background: #fff; color : black;">About</a>
      <a href="index.php#name=juno_okyo" class="button" style ="background: #fff; color : black;">DOM-based XSS</a>
    </header>
</div>

      

    <div class="container" style = " background: #4ECDC4;">
      <div class="row">
        <div class="col-sm-12">
